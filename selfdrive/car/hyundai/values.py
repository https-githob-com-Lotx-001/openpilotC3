...
CAR_INFO: Dict[str, Optional[Union[HyundaiCarInfo, List[HyundaiCarInfo]]]] = {
  ...
  CAR.KIA_K8_GEN: HyundaiCarInfo("Kia K8 GEN (with HDA II) 2023", "Highway Driving Assist II", car_parts=CarParts.common([CarHarness.hyundai_k])),
  ...
  CAR.KIA_CADENZA: HyundaiCarInfo("Kia CADENZA 2017-20", "All", car_parts=CarParts.common([CarHarness.hyundai_c])),
...
FW_VERSIONS = {
  ...
  CAR.KIA_CADENZA: {
    ...
    (Ecu.fwdRadar, 0x7d0, None): [
      b'\xf1\x00YG__ SCC     1.01 1.01 96400-F6000     \xf1\xa01.01',
      b'\xf1\x00YG__ SCC     1.00 1.04 96400-F6400     \xf1\xa01.04',
      b'\xf1\x00YG__ SCC     1.01 1.02 96400-F6000     \xf1\xa01.02',
      b'\xf1\x00YG__ SCC     1.00 1.01 99110-F6000     \xf1\xa01.01',
    ],
    (Ecu.abs, 0x7d1, None): [
...
LEGACY_SAFETY_MODE_CAR = {CAR.HYUNDAI_GENESIS, CAR.IONIQ_EV_LTD, CAR.KIA_CADENZA, CAR.KIA_OPTIMA_G4,
